...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE prevInstance, LPWSTR cmdLine, int cmdShow)
{
	...
	const auto hWnd = CreateApplicationWindow(hInstance, "DrawingSprites", "PNG file is displayed to the screen", canvas);
	...
	try
	{
		...
		if(dxWindow->LoadContent())
		{
			result = ApplicationLoop(dxWindow.get());

			dxWindow->UnloadContent();
		}
		else
		{
			MessageBox(hWnd, "DXWindow content was unable to be loaded", nullptr, NULL);
		}
	}
